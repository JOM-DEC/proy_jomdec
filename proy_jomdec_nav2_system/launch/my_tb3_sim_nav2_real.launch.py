...
def generate_launch_description():
    ...
    nav2_yaml = os.path.join(get_package_share_directory('proy_jomdec_nav2_system'), 'config', 'my_nav2_params.yaml')
    map_file = os.path.join(get_package_share_directory('proy_jomdec_nav2_system'), 'config', 'my_map_real.yaml')
    rviz_config_dir = os.path.join(get_package_share_directory('proy_jomdec_nav2_system'), 'config', 'config_rviz_real_camara.rviz')
