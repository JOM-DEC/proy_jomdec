...
class AudioManager:
    ...
    def __init__(self, logger, config_file, display_man, sound_man, porcupineApiKey="MqoPo38/dTKWMV9uY5zvorZBWTx6sYjnwkh1fsr6UzYxmmDJtg2AYg==", withAiApiKey="BJ7UQGT2X4PHWSBEFOMDB2GEBYL62Z6C"):
        # Porcupine handles the wakewords
        self.porc = pvporcupine.create(access_key=porcupineApiKey, keywords=["computer"])
