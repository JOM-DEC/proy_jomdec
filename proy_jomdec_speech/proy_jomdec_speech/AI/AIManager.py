...
class AIManager:
    ...
    def __init__(self, logger, config_file, display_man, sound_man, openAiApiKey="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"):
        self.l = logger
    ...
    def parse_config(self):
        ...
        openai.api_key = "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" ##self.openAiApiKey
